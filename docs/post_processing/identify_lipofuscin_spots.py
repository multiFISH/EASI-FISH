#Code for identify lipofuscin spots based on co-localization of the 488 and 669 channel
...
spot_c0 = np.loadtxt(spot_c0_path,delimiter=',')
spot_c1 = np.loadtxt(spot_c1_path,delimiter=',')
#spot_c0 = np.loadtxt(spot_c0_path)
#spot_c1 = np.loadtxt(spot_c1_path)

#vox=[0.23,0.23,0.42]
c0=spot_c0[:,:3].copy()
c1=spot_c1[:,:3].copy()

neighbor_radius   = 0.69
